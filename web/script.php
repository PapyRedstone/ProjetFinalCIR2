<?php	
	...
	function chaineAleatoire() {
		...
		$string = substr( $string , 0 , 10 ); // prendre les 10 1ers caractères.
		return $string;
	}
	...
	*/
	...
	echo"<h2>Insertion de données</h2>";
	...
	if($query->execute()){
		...
		echo "probleme lors de Insertion de données <br>";
	}
	...
	//mise en table des valeurs récupéres
	echo "<table border=\"1\">";
