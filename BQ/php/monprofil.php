...
<html lang="fr">
	...
	<div id="container">
		...
		<div class="panel panel-default">
		    <div class="panel-heading"><center><h4>Mes Scores</h4></center></div>
		    <table class="table">
			<tr>
			    <th>Place</th>
			    <th>Score</th>
			...
			foreach($scores as $score){
			    ...
			    echo '<td><button class ="submit" type="submit" value="supprime" id="supprimer" onclick="location.href=\'deleteScore.php/'.$score["id_palmares"].'\'"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></button></td></tr>';
			}
			?>
		    </table>
		</div>
