...
public:
    ...
    void setupUi(QDialog *Utilisateur)
    {
        ...
        verticalLayout_3 = new QVBoxLayout(Utilisateur);
        ...
        verticalLayout_3->addLayout(Header);
        ...
        table->setMinimumSize(QSize(360, 192));
        ...
        verticalLayout->addWidget(newPassButton);
